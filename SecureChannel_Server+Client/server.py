    ...
    def post(self):
    	try:
    		...
    		if os.path.exists(os.getcwd()+'/documents/'+filename):
    			...
    			file_data = file_data_read.split(b'\n')[3]
    			print(file_data)
    		...
    		if (file_flag=="1"):
    			...
    			print(file_data)
    			print(aes_key_dic)
    			_key = decryptor.decrypt(file_data)
...
class checkin(Resource):
    ...
    def post(self):
    	...
    	if self.security_flag =="1":
    		...
    		#print(encrypted_cipher, ciphertext, tag)
    		self._file.data = encrypted_cipher
